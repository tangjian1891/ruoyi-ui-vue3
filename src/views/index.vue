    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          ...
          <br />* 后端开发框架 Spring Boot、Redis
          <br />* 容器框架 Undertow 基于 Netty 的高性能容器
          <br />* 权限认证框架 Spring Security、Jwt，支持多终端认证系统
          <br />* 关系数据库 MySQL 适配 8.X
          <br />* 缓存数据库 Redis 适配 6.X
          <br />* 数据库开发框架 Mybatis-Plus 快速 CRUD 增加开发效率 插件化支持各类需求
          <br />* 网络框架 Feign、OkHttp3 接口化管理 HTTP 请求
          <br />* 工具类框架 Hutool、Lombok 减少代码冗余 增加安全性
          <br />* 监控框架 spring-boot-admin 全方位服务监控
          <br />* 校验框架 validation 增强接口安全性 严谨性
          <br />* 文档框架 knife4j 美化接口文档
          <br />* 代码生成器 一键生成前后端代码
          <br />* 多数据源框架 dynamic-datasource 支持主从与多种类数据库异构
          <br />* Redis客户端 采用 Redisson 性能更强
          <br />* 分布式锁 Lock4j 注解锁、工具锁 多种多样
          <br />* 部署方式 Docker 容器编排 一键部署业务集群
          <br />* 文件存储 OSS 对象存储模块 支持(Minio、七牛、阿里、腾讯)
          <br />
        </p>
        <p>
          <b>当前版本:</b>
          ...
          <el-collapse accordion>
            ...
            <el-collapse-item title="v2.5.2 - 2021-7-19">
              <ol>
                ...
                <li>fix 代码生成 queryType &lg;= &lt;= 标识符错误问题</li>
